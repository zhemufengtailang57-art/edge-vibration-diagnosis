...
主控板由嘉立创EDA 专业版设计，原理图 5 页 + PCB Layout，图纸与可编辑的工程源文件见 [`hardware/`](hardware/)。

| 页码 | 内容 | 关键器件 |
|------|------|----------|
| 1 | STM32 最小系统 | STM32F407ZGT6（LQFP144）、8 MHz 晶振、W25Q64、分区去耦 |
| 2 | 电源树 | 12V 输入 → MP2315GJ-Z（3.3V）/ HT7150（5V） |
| 3 | 传感器 | ADXL345（SPI）、DS18B20（1-Wire） |
